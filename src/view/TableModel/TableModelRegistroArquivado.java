...
public class TableModelRegistroArquivado extends AbstractTableModel  {

	List<Registro> registros;
	    
	public TableModelRegistroArquivado(String string)
	{
		registros = RegistroDAO.buscarCpfArquivado(string);
	}
