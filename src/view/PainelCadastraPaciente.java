...
public class PainelCadastraPaciente extends JPanel {
	...
	public PainelCadastraPaciente(JPanel painelPai) {
		...
		labelCpf.setFont(new Font("Tahoma", Font.PLAIN, 10));
		...
		textFieldUf.setFont(new Font("Tahoma", Font.PLAIN, 10));
		...
		labelDataSintoma.setFont(new Font("Tahoma", Font.PLAIN, 10));
		...
		botaoCadastrar.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				boolean validar = ValidarCPF.validar(textFieldCpf.getText());
