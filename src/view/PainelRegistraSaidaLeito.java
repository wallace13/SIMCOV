...
public class PainelRegistraSaidaLeito extends JPanel {
	...
	public PainelRegistraSaidaLeito(JPanel painelPai) {
		...
		textFieldTipo.setPreferredSize(new Dimension(240, 25));
		...
		textFieldNumero.setPreferredSize(new Dimension(50, 25));
        ...
        botaoRegistrar.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                {
                    GerenciadorLeitos.registrarSaida(RegistroDAO.buscarPorCpf(textFieldCpf.getText()));
